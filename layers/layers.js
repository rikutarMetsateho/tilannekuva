...
var format_HVOtoiminnassa_4 = new ol.format.GeoJSON();
var features_HVOtoiminnassa_4 = format_HVOtoiminnassa_4.readFeatures(json_HVOtoiminnassa_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_HVOtoiminnassa_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_HVOtoiminnassa_4.addFeatures(features_HVOtoiminnassa_4);
var lyr_HVOtoiminnassa_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_HVOtoiminnassa_4, 
                style: style_HVOtoiminnassa_4,
                popuplayertitle: 'HVO - toiminnassa',
                interactive: true,
                title: '<img src="styles/legend/HVOtoiminnassa_4.png" /> HVO - toiminnassa'
            });
...
var format_Shksuunnitteilla_7 = new ol.format.GeoJSON();
var features_Shksuunnitteilla_7 = format_Shksuunnitteilla_7.readFeatures(json_Shksuunnitteilla_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Shksuunnitteilla_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Shksuunnitteilla_7.addFeatures(features_Shksuunnitteilla_7);
var lyr_Shksuunnitteilla_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Shksuunnitteilla_7, 
                style: style_Shksuunnitteilla_7,
                popuplayertitle: 'Sähkö - suunnitteilla',
                interactive: true,
                title: '<img src="styles/legend/Shksuunnitteilla_7.png" /> Sähkö - suunnitteilla'
            });
var format_Shktoiminnassa_8 = new ol.format.GeoJSON();
var features_Shktoiminnassa_8 = format_Shktoiminnassa_8.readFeatures(json_Shktoiminnassa_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Shktoiminnassa_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Shktoiminnassa_8.addFeatures(features_Shktoiminnassa_8);
var lyr_Shktoiminnassa_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Shktoiminnassa_8, 
                style: style_Shktoiminnassa_8,
                popuplayertitle: 'Sähkö - toiminnassa',
                interactive: true,
                title: '<img src="styles/legend/Shktoiminnassa_8.png" /> Sähkö - toiminnassa'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_TENTKattavaverkko_1.setVisible(true);lyr_TENTYdinverkko_2.setVisible(true);lyr_TENTsatamat_3.setVisible(true);lyr_HVOtoiminnassa_4.setVisible(true);lyr_LBGsuunnitteilla_5.setVisible(true);lyr_LBGtoiminnassa_6.setVisible(true);lyr_Shksuunnitteilla_7.setVisible(true);lyr_Shktoiminnassa_8.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_TENTKattavaverkko_1,lyr_TENTYdinverkko_2,lyr_TENTsatamat_3,lyr_HVOtoiminnassa_4,lyr_LBGsuunnitteilla_5,lyr_LBGtoiminnassa_6,lyr_Shksuunnitteilla_7,lyr_Shktoiminnassa_8];
...
lyr_HVOtoiminnassa_4.set('fieldAliases', {'Yritys': 'Yritys', 'Nimi': 'Nimi', 'Käyttövoima': 'Käyttövoima', 'Teho kW': 'Teho kW', 'SijaintiN': 'SijaintiN', 'SijaintiE': 'SijaintiE', 'Tilanne': 'Tilanne', 'Kunta': 'Kunta', 'Lisätietoja1': 'Lisätietoja1', 'Lisätietoja2': 'Lisätietoja2', 'Linkki': 'Linkki', 'Osoite': 'Osoite', });
...
lyr_Shksuunnitteilla_7.set('fieldAliases', {'fid': 'fid', 'Yritys': 'Yritys', 'Nimi': 'Nimi', 'Käyttövoima': 'Käyttövoima', 'Teho kW': 'Teho kW', 'SijaintiN': 'SijaintiN', 'SijaintiE': 'SijaintiE', 'Tilanne': 'Tilanne', 'Kunta': 'Kunta', 'Lisätietoja1': 'Lisätietoja1', 'Linkki': 'Linkki', 'Osoite': 'Osoite', 'field_12': 'field_12', });
lyr_Shktoiminnassa_8.set('fieldAliases', {'fid': 'fid', 'Yritys': 'Yritys', 'Nimi': 'Nimi', 'Käyttövoima': 'Käyttövoima', 'Teho kW': 'Teho kW', 'SijaintiN': 'SijaintiN', 'SijaintiE': 'SijaintiE', 'Tilanne': 'Tilanne', 'Kunta': 'Kunta', 'Lisätietoja1': 'Lisätietoja1', 'Linkki': 'Linkki', 'Osoite': 'Osoite', 'field_12': 'field_12', });
...
lyr_HVOtoiminnassa_4.set('fieldImages', {'Yritys': 'TextEdit', 'Nimi': 'TextEdit', 'Käyttövoima': 'TextEdit', 'Teho kW': 'TextEdit', 'SijaintiN': 'TextEdit', 'SijaintiE': 'TextEdit', 'Tilanne': 'TextEdit', 'Kunta': 'TextEdit', 'Lisätietoja1': 'TextEdit', 'Lisätietoja2': 'TextEdit', 'Linkki': 'TextEdit', 'Osoite': 'TextEdit', });
lyr_LBGsuunnitteilla_5.set('fieldImages', {'fid': '', 'Yritys': '', 'Nimi': '', 'Käyttövoima': '', 'Teho kW': '', 'SijaintiN': '', 'SijaintiE': '', 'Tilanne': '', 'Kunta': '', 'Lisätietoja1': '', 'Linkki': '', 'Osoite': '', });
...
lyr_Shksuunnitteilla_7.set('fieldImages', {'fid': '', 'Yritys': '', 'Nimi': '', 'Käyttövoima': '', 'Teho kW': '', 'SijaintiN': '', 'SijaintiE': '', 'Tilanne': '', 'Kunta': '', 'Lisätietoja1': '', 'Linkki': '', 'Osoite': '', 'field_12': '', });
lyr_Shktoiminnassa_8.set('fieldImages', {'fid': 'TextEdit', 'Yritys': 'TextEdit', 'Nimi': 'TextEdit', 'Käyttövoima': 'TextEdit', 'Teho kW': 'TextEdit', 'SijaintiN': 'TextEdit', 'SijaintiE': 'TextEdit', 'Tilanne': 'TextEdit', 'Kunta': 'TextEdit', 'Lisätietoja1': 'TextEdit', 'Linkki': 'TextEdit', 'Osoite': 'TextEdit', 'field_12': 'TextEdit', });
...
lyr_HVOtoiminnassa_4.set('fieldLabels', {'Yritys': 'no label', 'Nimi': 'no label', 'Käyttövoima': 'no label', 'Teho kW': 'no label', 'SijaintiN': 'no label', 'SijaintiE': 'no label', 'Tilanne': 'no label', 'Kunta': 'no label', 'Lisätietoja1': 'no label', 'Lisätietoja2': 'no label', 'Linkki': 'no label', 'Osoite': 'no label', });
lyr_LBGsuunnitteilla_5.set('fieldLabels', {'fid': 'no label', 'Yritys': 'no label', 'Nimi': 'no label', 'Käyttövoima': 'no label', 'Teho kW': 'no label', 'SijaintiN': 'no label', 'SijaintiE': 'no label', 'Tilanne': 'no label', 'Kunta': 'no label', 'Lisätietoja1': 'no label', 'Linkki': 'no label', 'Osoite': 'no label', });
lyr_LBGtoiminnassa_6.set('fieldLabels', {'fid': 'no label', 'Yritys': 'no label', 'Nimi': 'no label', 'Käyttövoima': 'no label', 'Teho kW': 'no label', 'SijaintiN': 'no label', 'SijaintiE': 'no label', 'Tilanne': 'no label', 'Kunta': 'no label', 'Lisätietoja1': 'no label', 'Linkki': 'no label', 'Osoite': 'no label', });
lyr_Shksuunnitteilla_7.set('fieldLabels', {'fid': 'no label', 'Yritys': 'no label', 'Nimi': 'no label', 'Käyttövoima': 'no label', 'Teho kW': 'no label', 'SijaintiN': 'no label', 'SijaintiE': 'no label', 'Tilanne': 'no label', 'Kunta': 'no label', 'Lisätietoja1': 'no label', 'Linkki': 'no label', 'Osoite': 'no label', 'field_12': 'no label', });
lyr_Shktoiminnassa_8.set('fieldLabels', {'fid': 'no label', 'Yritys': 'no label', 'Nimi': 'no label', 'Käyttövoima': 'no label', 'Teho kW': 'no label', 'SijaintiN': 'no label', 'SijaintiE': 'no label', 'Tilanne': 'no label', 'Kunta': 'no label', 'Lisätietoja1': 'no label', 'Linkki': 'no label', 'Osoite': 'no label', 'field_12': 'no label', });
lyr_Shktoiminnassa_8.on('precompose', function(evt) {
