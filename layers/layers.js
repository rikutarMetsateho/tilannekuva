...
var format_Vetysuunnitteilla_4 = new ol.format.GeoJSON();
var features_Vetysuunnitteilla_4 = format_Vetysuunnitteilla_4.readFeatures(json_Vetysuunnitteilla_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Vetysuunnitteilla_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Vetysuunnitteilla_4.addFeatures(features_Vetysuunnitteilla_4);
var lyr_Vetysuunnitteilla_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Vetysuunnitteilla_4, 
                style: style_Vetysuunnitteilla_4,
                popuplayertitle: 'Vety - suunnitteilla',
                interactive: true,
                title: '<img src="styles/legend/Vetysuunnitteilla_4.png" /> Vety - suunnitteilla'
            });
...
var format_HVOsuunnitteilla_7 = new ol.format.GeoJSON();
var features_HVOsuunnitteilla_7 = format_HVOsuunnitteilla_7.readFeatures(json_HVOsuunnitteilla_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_HVOsuunnitteilla_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_HVOsuunnitteilla_7.addFeatures(features_HVOsuunnitteilla_7);
var lyr_HVOsuunnitteilla_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_HVOsuunnitteilla_7, 
                style: style_HVOsuunnitteilla_7,
                popuplayertitle: 'HVO - suunnitteilla',
                interactive: true,
                title: '<img src="styles/legend/HVOsuunnitteilla_7.png" /> HVO - suunnitteilla'
            });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_TENTKattavaverkko_1.setVisible(true);lyr_TENTYdinverkko_2.setVisible(true);lyr_TENTsatamat_3.setVisible(true);lyr_Vetysuunnitteilla_4.setVisible(true);lyr_LBGsuunnitteilla_5.setVisible(true);lyr_LBGtoiminnassa_6.setVisible(true);lyr_HVOsuunnitteilla_7.setVisible(true);lyr_HVOsuunnitteilla_8.setVisible(true);lyr_Shksuunnitteilla_9.setVisible(true);lyr_Shktoiminnassa_10.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_TENTKattavaverkko_1,lyr_TENTYdinverkko_2,lyr_TENTsatamat_3,lyr_Vetysuunnitteilla_4,lyr_LBGsuunnitteilla_5,lyr_LBGtoiminnassa_6,lyr_HVOsuunnitteilla_7,lyr_HVOsuunnitteilla_8,lyr_Shksuunnitteilla_9,lyr_Shktoiminnassa_10];
...
lyr_Vetysuunnitteilla_4.set('fieldAliases', {'fid': 'fid', 'Yritys': 'Yritys', 'Nimi': 'Nimi', 'Käyttövoima': 'Käyttövoima', 'SijaintiN': 'SijaintiN', 'SijaintiE': 'SijaintiE', 'Tilanne': 'Tilanne', 'Kunta': 'Kunta', 'Lisätietoja1': 'Lisätietoja1', 'Lisätietoja2': 'Lisätietoja2', 'Linkki': 'Linkki', 'Osoite': 'Osoite', });
lyr_LBGsuunnitteilla_5.set('fieldAliases', {'fid': 'fid', 'Yritys': 'Yritys', 'Nimi': 'Nimi', 'Käyttövoima': 'Käyttövoima', 'SijaintiN': 'SijaintiN', 'SijaintiE': 'SijaintiE', 'Tilanne': 'Tilanne', 'Kunta': 'Kunta', 'Lisätietoja1': 'Lisätietoja1', 'Lisätietoja2': 'Lisätietoja2', 'Linkki': 'Linkki', 'Osoite': 'Osoite', });
lyr_LBGtoiminnassa_6.set('fieldAliases', {'fid': 'fid', 'Yritys': 'Yritys', 'Nimi': 'Nimi', 'Käyttövoima': 'Käyttövoima', 'SijaintiN': 'SijaintiN', 'SijaintiE': 'SijaintiE', 'Tilanne': 'Tilanne', 'Kunta': 'Kunta', 'Lisätietoja1': 'Lisätietoja1', 'Lisätietoja2': 'Lisätietoja2', 'Linkki': 'Linkki', 'Osoite': 'Osoite', });
lyr_HVOsuunnitteilla_7.set('fieldAliases', {'fid': 'fid', 'Yritys': 'Yritys', 'Nimi': 'Nimi', 'Käyttövoima': 'Käyttövoima', 'SijaintiN': 'SijaintiN', 'SijaintiE': 'SijaintiE', 'Tilanne': 'Tilanne', 'Kunta': 'Kunta', 'Lisätietoja1': 'Lisätietoja1', 'Lisätietoja2': 'Lisätietoja2', 'Linkki': 'Linkki', 'Osoite': 'Osoite', });
...
lyr_Shksuunnitteilla_9.set('fieldAliases', {'fid': 'fid', 'Yritys': 'Yritys', 'Nimi': 'Nimi', 'Käyttövoima': 'Käyttövoima', 'SijaintiN': 'SijaintiN', 'SijaintiE': 'SijaintiE', 'Tilanne': 'Tilanne', 'Kunta': 'Kunta', 'Lisätietoja1': 'Lisätietoja1', 'Lisätietoja2': 'Lisätietoja2', 'Linkki': 'Linkki', 'Osoite': 'Osoite', });
lyr_Shktoiminnassa_10.set('fieldAliases', {'fid': 'fid', 'Yritys': 'Yritys', 'Nimi': 'Nimi', 'Käyttövoima': 'Käyttövoima', 'SijaintiN': 'SijaintiN', 'SijaintiE': 'SijaintiE', 'Tilanne': 'Tilanne', 'Kunta': 'Kunta', 'Lisätietoja1': 'Lisätietoja1', 'Lisätietoja2': 'Lisätietoja2', 'Linkki': 'Linkki', 'Osoite': 'Osoite', });
...
lyr_Vetysuunnitteilla_4.set('fieldImages', {'fid': 'TextEdit', 'Yritys': 'TextEdit', 'Nimi': 'TextEdit', 'Käyttövoima': 'TextEdit', 'SijaintiN': 'TextEdit', 'SijaintiE': 'TextEdit', 'Tilanne': 'TextEdit', 'Kunta': 'TextEdit', 'Lisätietoja1': 'TextEdit', 'Lisätietoja2': 'TextEdit', 'Linkki': 'TextEdit', 'Osoite': 'TextEdit', });
lyr_LBGsuunnitteilla_5.set('fieldImages', {'fid': 'TextEdit', 'Yritys': 'TextEdit', 'Nimi': 'TextEdit', 'Käyttövoima': 'TextEdit', 'SijaintiN': 'TextEdit', 'SijaintiE': 'TextEdit', 'Tilanne': 'TextEdit', 'Kunta': 'TextEdit', 'Lisätietoja1': 'TextEdit', 'Lisätietoja2': 'TextEdit', 'Linkki': 'TextEdit', 'Osoite': 'TextEdit', });
lyr_LBGtoiminnassa_6.set('fieldImages', {'fid': 'TextEdit', 'Yritys': 'TextEdit', 'Nimi': 'TextEdit', 'Käyttövoima': 'TextEdit', 'SijaintiN': 'TextEdit', 'SijaintiE': 'TextEdit', 'Tilanne': 'TextEdit', 'Kunta': 'TextEdit', 'Lisätietoja1': 'TextEdit', 'Lisätietoja2': 'TextEdit', 'Linkki': 'TextEdit', 'Osoite': 'TextEdit', });
lyr_HVOsuunnitteilla_7.set('fieldImages', {'fid': 'TextEdit', 'Yritys': 'TextEdit', 'Nimi': 'TextEdit', 'Käyttövoima': 'TextEdit', 'SijaintiN': 'TextEdit', 'SijaintiE': 'TextEdit', 'Tilanne': 'TextEdit', 'Kunta': 'TextEdit', 'Lisätietoja1': 'TextEdit', 'Lisätietoja2': 'TextEdit', 'Linkki': 'TextEdit', 'Osoite': 'TextEdit', });
...
lyr_Shksuunnitteilla_9.set('fieldImages', {'fid': 'TextEdit', 'Yritys': 'TextEdit', 'Nimi': 'TextEdit', 'Käyttövoima': 'TextEdit', 'SijaintiN': 'TextEdit', 'SijaintiE': 'TextEdit', 'Tilanne': 'TextEdit', 'Kunta': 'TextEdit', 'Lisätietoja1': 'TextEdit', 'Lisätietoja2': 'TextEdit', 'Linkki': 'TextEdit', 'Osoite': 'TextEdit', });
lyr_Shktoiminnassa_10.set('fieldImages', {'fid': 'TextEdit', 'Yritys': 'TextEdit', 'Nimi': 'TextEdit', 'Käyttövoima': 'TextEdit', 'SijaintiN': 'TextEdit', 'SijaintiE': 'TextEdit', 'Tilanne': 'TextEdit', 'Kunta': 'TextEdit', 'Lisätietoja1': 'TextEdit', 'Lisätietoja2': 'TextEdit', 'Linkki': 'TextEdit', 'Osoite': 'TextEdit', });
...
lyr_Vetysuunnitteilla_4.set('fieldLabels', {'fid': 'inline label - visible with data', 'Yritys': 'inline label - visible with data', 'Nimi': 'inline label - visible with data', 'Käyttövoima': 'inline label - visible with data', 'SijaintiN': 'inline label - visible with data', 'SijaintiE': 'inline label - visible with data', 'Tilanne': 'inline label - visible with data', 'Kunta': 'inline label - visible with data', 'Lisätietoja1': 'inline label - visible with data', 'Lisätietoja2': 'inline label - visible with data', 'Linkki': 'inline label - visible with data', 'Osoite': 'inline label - visible with data', });
lyr_LBGsuunnitteilla_5.set('fieldLabels', {'fid': 'inline label - visible with data', 'Yritys': 'inline label - visible with data', 'Nimi': 'inline label - visible with data', 'Käyttövoima': 'inline label - visible with data', 'SijaintiN': 'inline label - visible with data', 'SijaintiE': 'inline label - visible with data', 'Tilanne': 'inline label - visible with data', 'Kunta': 'inline label - visible with data', 'Lisätietoja1': 'inline label - visible with data', 'Lisätietoja2': 'inline label - visible with data', 'Linkki': 'inline label - visible with data', 'Osoite': 'inline label - visible with data', });
...
lyr_HVOsuunnitteilla_7.set('fieldLabels', {'fid': 'inline label - visible with data', 'Yritys': 'inline label - visible with data', 'Nimi': 'inline label - visible with data', 'Käyttövoima': 'inline label - visible with data', 'SijaintiN': 'inline label - visible with data', 'SijaintiE': 'inline label - visible with data', 'Tilanne': 'inline label - visible with data', 'Kunta': 'inline label - visible with data', 'Lisätietoja1': 'inline label - visible with data', 'Lisätietoja2': 'inline label - visible with data', 'Linkki': 'inline label - visible with data', 'Osoite': 'inline label - visible with data', });
lyr_HVOsuunnitteilla_8.set('fieldLabels', {'fid': 'inline label - visible with data', 'Yritys': 'inline label - visible with data', 'Nimi': 'inline label - visible with data', 'Käyttövoima': 'inline label - visible with data', 'SijaintiN': 'inline label - visible with data', 'SijaintiE': 'inline label - visible with data', 'Tilanne': 'inline label - visible with data', 'Kunta': 'inline label - visible with data', 'Lisätietoja1': 'inline label - visible with data', 'Lisätietoja2': 'inline label - visible with data', 'Linkki': 'inline label - visible with data', 'Osoite': 'inline label - visible with data', });
lyr_Shksuunnitteilla_9.set('fieldLabels', {'fid': 'inline label - visible with data', 'Yritys': 'inline label - visible with data', 'Nimi': 'inline label - visible with data', 'Käyttövoima': 'inline label - visible with data', 'SijaintiN': 'inline label - visible with data', 'SijaintiE': 'inline label - visible with data', 'Tilanne': 'inline label - visible with data', 'Kunta': 'inline label - visible with data', 'Lisätietoja1': 'inline label - visible with data', 'Lisätietoja2': 'inline label - visible with data', 'Linkki': 'inline label - visible with data', 'Osoite': 'inline label - visible with data', });
lyr_Shktoiminnassa_10.set('fieldLabels', {'fid': 'inline label - visible with data', 'Yritys': 'inline label - visible with data', 'Nimi': 'inline label - visible with data', 'Käyttövoima': 'inline label - visible with data', 'SijaintiN': 'inline label - visible with data', 'SijaintiE': 'inline label - visible with data', 'Tilanne': 'inline label - visible with data', 'Kunta': 'inline label - visible with data', 'Lisätietoja1': 'inline label - visible with data', 'Lisätietoja2': 'inline label - visible with data', 'Linkki': 'inline label - visible with data', 'Osoite': 'inline label - visible with data', });
