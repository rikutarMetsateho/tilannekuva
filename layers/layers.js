...
var format_satamat_4 = new ol.format.GeoJSON();
var features_satamat_4 = format_satamat_4.readFeatures(json_satamat_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_satamat_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_satamat_4.addFeatures(features_satamat_4);
var lyr_satamat_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_satamat_4, 
                style: style_satamat_4,
                popuplayertitle: 'satamat',
                interactive: true,
                title: '<img src="styles/legend/satamat_4.png" /> satamat'
            });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_TENTKattavaverkko_1.setVisible(true);lyr_TENTYdinverkko_2.setVisible(true);lyr_Tehtaat_3.setVisible(false);lyr_satamat_4.setVisible(true);lyr_LBGsuunnitteilla_5.setVisible(true);lyr_LBGtoiminnassa_6.setVisible(true);lyr_HVOtoiminnassa_7.setVisible(true);lyr_Shksuunnitteilla_8.setVisible(true);lyr_Shktoiminnassa_9.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_TENTKattavaverkko_1,lyr_TENTYdinverkko_2,lyr_Tehtaat_3,lyr_satamat_4,lyr_LBGsuunnitteilla_5,lyr_LBGtoiminnassa_6,lyr_HVOtoiminnassa_7,lyr_Shksuunnitteilla_8,lyr_Shktoiminnassa_9];
...
lyr_satamat_4.set('fieldAliases', {'TEN-T-satama': 'TEN-T-satama', 'Ydin/kattava': 'Ydin/kattava', 'Kunta': 'Kunta', 'SijaintiN': 'SijaintiN', 'SijaintiE': 'SijaintiE', 'Lähde': 'Lähde', 'Muuta': 'Muuta', });
...
lyr_satamat_4.set('fieldImages', {'TEN-T-satama': 'TextEdit', 'Ydin/kattava': 'TextEdit', 'Kunta': 'TextEdit', 'SijaintiN': 'TextEdit', 'SijaintiE': 'TextEdit', 'Lähde': 'TextEdit', 'Muuta': 'TextEdit', });
...
lyr_satamat_4.set('fieldLabels', {'TEN-T-satama': 'no label', 'Ydin/kattava': 'no label', 'Kunta': 'no label', 'SijaintiN': 'no label', 'SijaintiE': 'no label', 'Lähde': 'no label', 'Muuta': 'no label', });
...
lyr_HVOtoiminnassa_7.set('fieldLabels', {'Yritys': 'no label', 'Nimi': 'no label', 'Käyttövoima': 'no label', 'Teho kW': 'no label', 'SijaintiN': 'no label', 'SijaintiE': 'no label', 'Tilanne': 'no label', 'Kunta': 'no label', 'Lisätietoja1': 'no label', 'Lisätietoja2': 'no label', 'Linkki': 'no label', 'Osoite': 'no label', });
