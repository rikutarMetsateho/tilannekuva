...
lyr_Tehtaat2026_4.set('fieldLabels', {'TL_NRO': 'no label', 'N_ERTS': 'no label', 'E_ERTS': 'no label', 'Tyyppi': 'inline label - visible with data', 'Tuotantolaitos': 'hidden field', });
...
lyr_Shksuunnitteilla_9.set('fieldLabels', {'NAP-tunniste': 'hidden field', 'Yritys': 'inline label - visible with data', 'Nimi': 'inline label - visible with data', 'K�ytt�voima': 'hidden field', 'Teho kW': 'hidden field', 'SijaintiN': 'hidden field', 'SijaintiE': 'hidden field', 'Tilanne': 'inline label - visible with data', 'Kunta': 'inline label - visible with data', 'Lis�tietoja1': 'inline label - visible with data', 'Linkki': 'inline label - visible with data', 'Osoite': 'inline label - visible with data', 'field_13': 'hidden field', });
