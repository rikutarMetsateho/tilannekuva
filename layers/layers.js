...
var format_HVO_4 = new ol.format.GeoJSON();
var features_HVO_4 = format_HVO_4.readFeatures(json_HVO_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_HVO_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_HVO_4.addFeatures(features_HVO_4);
var lyr_HVO_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_HVO_4, 
                style: style_HVO_4,
                popuplayertitle: 'HVO',
                interactive: true,
                title: '<img src="styles/legend/HVO_4.png" /> HVO'
            });
var format_LBG_5 = new ol.format.GeoJSON();
var features_LBG_5 = format_LBG_5.readFeatures(json_LBG_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LBG_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LBG_5.addFeatures(features_LBG_5);
var lyr_LBG_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LBG_5, 
                style: style_LBG_5,
                popuplayertitle: 'LBG',
                interactive: true,
    title: 'LBG<br />\
    <img src="styles/legend/LBG_5_0.png" /> Suunnitteilla<br />\
    <img src="styles/legend/LBG_5_1.png" /> Toiminnassa<br />' });
...
var lyr_Shk_6 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'Sähkö<br />\
    <img src="styles/legend/Shk_6_0.png" /> Toiminnassa<br />\
    <img src="styles/legend/Shk_6_1.png" /> Suunnitteilla<br />' });

lyr_OpenStreetMap_0.setVisible(true);lyr_TENTKattavaverkko_1.setVisible(true);lyr_TENTYdinverkko_2.setVisible(true);lyr_TENTsatamat_3.setVisible(true);lyr_HVO_4.setVisible(true);lyr_LBG_5.setVisible(true);lyr_Shk_6.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_TENTKattavaverkko_1,lyr_TENTYdinverkko_2,lyr_TENTsatamat_3,lyr_HVO_4,lyr_LBG_5,lyr_Shk_6];
...
lyr_HVO_4.set('fieldAliases', {'Yritys': 'Yritys', 'Nimi': 'Nimi', 'Käyttövoima': 'Käyttövoima', 'Teho kW': 'Teho kW', 'SijaintiN': 'SijaintiN', 'SijaintiE': 'SijaintiE', 'Tilanne': 'Tilanne', 'Kunta': 'Kunta', 'Lisätietoja1': 'Lisätietoja1', 'Lisätietoja2': 'Lisätietoja2', 'Linkki': 'Linkki', 'Osoite': 'Osoite', });
lyr_LBG_5.set('fieldAliases', {'Yritys': 'Yritys', 'Nimi': 'Nimi', 'Käyttövoima': 'Käyttövoima', 'Teho kW': 'Teho kW', 'SijaintiN': 'SijaintiN', 'SijaintiE': 'SijaintiE', 'Tilanne': 'Tilanne', 'Kunta': 'Kunta', 'Lisätietoja1': 'Lisätietoja1', 'Linkki': 'Linkki', 'Osoite': 'Osoite', });
lyr_Shk_6.set('fieldAliases', {'fid': 'fid', 'Yritys': 'Yritys', 'Nimi': 'Nimi', 'Käyttövoima': 'Käyttövoima', 'Teho kW': 'Teho kW', 'SijaintiN': 'SijaintiN', 'SijaintiE': 'SijaintiE', 'Tilanne': 'Tilanne', 'Kunta': 'Kunta', 'Lisätietoja1': 'Lisätietoja1', 'Linkki': 'Linkki', 'Osoite': 'Osoite', 'field_12': 'field_12', });
...
lyr_HVO_4.set('fieldImages', {'Yritys': 'TextEdit', 'Nimi': 'TextEdit', 'Käyttövoima': 'TextEdit', 'Teho kW': 'TextEdit', 'SijaintiN': 'TextEdit', 'SijaintiE': 'TextEdit', 'Tilanne': 'TextEdit', 'Kunta': 'TextEdit', 'Lisätietoja1': 'TextEdit', 'Lisätietoja2': 'TextEdit', 'Linkki': 'TextEdit', 'Osoite': 'TextEdit', });
lyr_LBG_5.set('fieldImages', {'Yritys': 'TextEdit', 'Nimi': 'TextEdit', 'Käyttövoima': 'TextEdit', 'Teho kW': 'TextEdit', 'SijaintiN': 'TextEdit', 'SijaintiE': 'TextEdit', 'Tilanne': 'TextEdit', 'Kunta': 'TextEdit', 'Lisätietoja1': 'TextEdit', 'Linkki': 'TextEdit', 'Osoite': 'TextEdit', });
lyr_Shk_6.set('fieldImages', {'fid': 'TextEdit', 'Yritys': 'TextEdit', 'Nimi': 'TextEdit', 'Käyttövoima': 'TextEdit', 'Teho kW': 'TextEdit', 'SijaintiN': 'TextEdit', 'SijaintiE': 'TextEdit', 'Tilanne': 'TextEdit', 'Kunta': 'TextEdit', 'Lisätietoja1': 'TextEdit', 'Linkki': 'TextEdit', 'Osoite': 'TextEdit', 'field_12': 'TextEdit', });
...
lyr_HVO_4.set('fieldLabels', {'Yritys': 'no label', 'Nimi': 'no label', 'Käyttövoima': 'no label', 'Teho kW': 'no label', 'SijaintiN': 'no label', 'SijaintiE': 'no label', 'Tilanne': 'no label', 'Kunta': 'no label', 'Lisätietoja1': 'no label', 'Lisätietoja2': 'no label', 'Linkki': 'no label', 'Osoite': 'no label', });
lyr_LBG_5.set('fieldLabels', {'Yritys': 'no label', 'Nimi': 'no label', 'Käyttövoima': 'no label', 'Teho kW': 'no label', 'SijaintiN': 'no label', 'SijaintiE': 'no label', 'Tilanne': 'no label', 'Kunta': 'no label', 'Lisätietoja1': 'no label', 'Linkki': 'no label', 'Osoite': 'no label', });
lyr_Shk_6.set('fieldLabels', {'fid': 'no label', 'Yritys': 'no label', 'Nimi': 'no label', 'Käyttövoima': 'no label', 'Teho kW': 'no label', 'SijaintiN': 'no label', 'SijaintiE': 'no label', 'Tilanne': 'no label', 'Kunta': 'no label', 'Lisätietoja1': 'no label', 'Linkki': 'no label', 'Osoite': 'no label', 'field_12': 'no label', });
lyr_Shk_6.on('precompose', function(evt) {
