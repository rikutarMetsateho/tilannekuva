...
var format_HVOtoiminnassa_5 = new ol.format.GeoJSON();
var features_HVOtoiminnassa_5 = format_HVOtoiminnassa_5.readFeatures(json_HVOtoiminnassa_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_HVOtoiminnassa_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_HVOtoiminnassa_5.addFeatures(features_HVOtoiminnassa_5);
var lyr_HVOtoiminnassa_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_HVOtoiminnassa_5, 
                style: style_HVOtoiminnassa_5,
                popuplayertitle: 'HVO - toiminnassa',
                interactive: true,
                title: '<img src="styles/legend/HVOtoiminnassa_5.png" /> HVO - toiminnassa'
            });
var format_Tehtaat2026_6 = new ol.format.GeoJSON();
var features_Tehtaat2026_6 = format_Tehtaat2026_6.readFeatures(json_Tehtaat2026_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Tehtaat2026_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Tehtaat2026_6.addFeatures(features_Tehtaat2026_6);
var lyr_Tehtaat2026_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Tehtaat2026_6, 
                style: style_Tehtaat2026_6,
                popuplayertitle: 'Tehtaat 2026',
                interactive: true,
    title: 'Tehtaat 2026<br />\
    <img src="styles/legend/Tehtaat2026_6_0.png" /> Massateollisuus<br />\
    <img src="styles/legend/Tehtaat2026_6_1.png" /> Puutuoteteollisuus<br />' });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_TENTKattavaverkko_1.setVisible(true);lyr_TENTYdinverkko_2.setVisible(true);lyr_TENTsatamat_3.setVisible(true);lyr_Vetysuunnitteilla_4.setVisible(true);lyr_HVOtoiminnassa_5.setVisible(true);lyr_Tehtaat2026_6.setVisible(false);lyr_LBGsuunnitteilla_7.setVisible(true);lyr_LBGtoiminnassa_8.setVisible(true);lyr_Shksuunnitteilla_9.setVisible(true);lyr_Shktoiminnassa_10.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_TENTKattavaverkko_1,lyr_TENTYdinverkko_2,lyr_TENTsatamat_3,lyr_Vetysuunnitteilla_4,lyr_HVOtoiminnassa_5,lyr_Tehtaat2026_6,lyr_LBGsuunnitteilla_7,lyr_LBGtoiminnassa_8,lyr_Shksuunnitteilla_9,lyr_Shktoiminnassa_10];
...
lyr_Vetysuunnitteilla_4.set('fieldAliases', {'NAP-tunniste': 'NAP-tunniste', 'Yritys': 'Yritys', 'Nimi': 'Nimi', 'Käyttövoima': 'Käyttövoima', 'Teho kW': 'Teho kW', 'SijaintiN': 'SijaintiN', 'SijaintiE': 'SijaintiE', 'Tilanne': 'Tilanne', 'Kunta': 'Kunta', 'Lisätietoja1': 'Lisätietoja1', 'Linkki': 'Linkki', 'Osoite': 'Osoite', });
lyr_HVOtoiminnassa_5.set('fieldAliases', {'Yritys': 'Yritys', 'Nimi': 'Nimi', 'Käyttövoima': 'Käyttövoima', 'Teho kW': 'Teho kW', 'SijaintiN': 'SijaintiN', 'SijaintiE': 'SijaintiE', 'Tilanne': 'Tilanne', 'Kunta': 'Kunta', 'Lisätietoja1': 'Lisätietoja1', 'Lisätietoja2': 'Lisätietoja2', 'Linkki': 'Linkki', 'Osoite': 'Osoite', });
lyr_Tehtaat2026_6.set('fieldAliases', {'TL_NRO': 'TL_NRO', 'N_ERTS': 'N_ERTS', 'E_ERTS': 'E_ERTS', 'Tyyppi': 'Tyyppi', 'Tuotantolaitos': 'Tuotantolaitos', });
...
lyr_Vetysuunnitteilla_4.set('fieldImages', {'NAP-tunniste': 'TextEdit', 'Yritys': 'TextEdit', 'Nimi': 'TextEdit', 'Käyttövoima': 'TextEdit', 'Teho kW': 'TextEdit', 'SijaintiN': 'TextEdit', 'SijaintiE': 'TextEdit', 'Tilanne': 'TextEdit', 'Kunta': 'TextEdit', 'Lisätietoja1': 'TextEdit', 'Linkki': 'TextEdit', 'Osoite': 'TextEdit', });
lyr_HVOtoiminnassa_5.set('fieldImages', {'Yritys': 'TextEdit', 'Nimi': 'TextEdit', 'Käyttövoima': 'TextEdit', 'Teho kW': 'TextEdit', 'SijaintiN': 'TextEdit', 'SijaintiE': 'TextEdit', 'Tilanne': 'TextEdit', 'Kunta': 'TextEdit', 'Lisätietoja1': 'TextEdit', 'Lisätietoja2': 'TextEdit', 'Linkki': 'TextEdit', 'Osoite': 'TextEdit', });
lyr_Tehtaat2026_6.set('fieldImages', {'TL_NRO': '', 'N_ERTS': '', 'E_ERTS': '', 'Tyyppi': 'TextEdit', 'Tuotantolaitos': 'TextEdit', });
...
lyr_Vetysuunnitteilla_4.set('fieldLabels', {'NAP-tunniste': 'no label', 'Yritys': 'no label', 'Nimi': 'no label', 'Käyttövoima': 'no label', 'Teho kW': 'no label', 'SijaintiN': 'no label', 'SijaintiE': 'no label', 'Tilanne': 'no label', 'Kunta': 'no label', 'Lisätietoja1': 'no label', 'Linkki': 'no label', 'Osoite': 'no label', });
lyr_HVOtoiminnassa_5.set('fieldLabels', {'Yritys': 'inline label - visible with data', 'Nimi': 'inline label - visible with data', 'Käyttövoima': 'inline label - visible with data', 'Teho kW': 'hidden field', 'SijaintiN': 'hidden field', 'SijaintiE': 'hidden field', 'Tilanne': 'inline label - visible with data', 'Kunta': 'hidden field', 'Lisätietoja1': 'inline label - visible with data', 'Lisätietoja2': 'inline label - visible with data', 'Linkki': 'inline label - visible with data', 'Osoite': 'inline label - visible with data', });
lyr_Tehtaat2026_6.set('fieldLabels', {'TL_NRO': 'no label', 'N_ERTS': 'no label', 'E_ERTS': 'no label', 'Tyyppi': 'header label - visible with data', 'Tuotantolaitos': 'hidden field', });
