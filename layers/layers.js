...
var format_Liikenteensolmukunnat_3 = new ol.format.GeoJSON();
var features_Liikenteensolmukunnat_3 = format_Liikenteensolmukunnat_3.readFeatures(json_Liikenteensolmukunnat_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Liikenteensolmukunnat_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Liikenteensolmukunnat_3.addFeatures(features_Liikenteensolmukunnat_3);
var lyr_Liikenteensolmukunnat_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Liikenteensolmukunnat_3, 
                style: style_Liikenteensolmukunnat_3,
                popuplayertitle: 'Liikenteen solmukunnat',
                interactive: true,
                title: '<img src="styles/legend/Liikenteensolmukunnat_3.png" /> Liikenteen solmukunnat'
            });
var format_solmukunnat_pisteclipped_4 = new ol.format.GeoJSON();
var features_solmukunnat_pisteclipped_4 = format_solmukunnat_pisteclipped_4.readFeatures(json_solmukunnat_pisteclipped_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_solmukunnat_pisteclipped_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_solmukunnat_pisteclipped_4.addFeatures(features_solmukunnat_pisteclipped_4);
var lyr_solmukunnat_pisteclipped_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_solmukunnat_pisteclipped_4, 
                style: style_solmukunnat_pisteclipped_4,
                popuplayertitle: 'solmukunnat_piste — clipped',
                interactive: true,
                title: '<img src="styles/legend/solmukunnat_pisteclipped_4.png" /> solmukunnat_piste — clipped'
            });
...
var format_Tehtaat_6 = new ol.format.GeoJSON();
var features_Tehtaat_6 = format_Tehtaat_6.readFeatures(json_Tehtaat_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Tehtaat_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Tehtaat_6.addFeatures(features_Tehtaat_6);
var lyr_Tehtaat_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Tehtaat_6, 
                style: style_Tehtaat_6,
                popuplayertitle: 'Tehtaat',
                interactive: true,
    title: 'Tehtaat<br />\
    <img src="styles/legend/Tehtaat_6_0.png" /> Massateollisuus<br />\
    <img src="styles/legend/Tehtaat_6_1.png" /> Puutuoteteollisuus<br />' });
var format_Suunnitteilla_7 = new ol.format.GeoJSON();
var features_Suunnitteilla_7 = format_Suunnitteilla_7.readFeatures(json_Suunnitteilla_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Suunnitteilla_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Suunnitteilla_7.addFeatures(features_Suunnitteilla_7);
var lyr_Suunnitteilla_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Suunnitteilla_7, 
                style: style_Suunnitteilla_7,
                popuplayertitle: 'Suunnitteilla',
                interactive: true,
                title: '<img src="styles/legend/Suunnitteilla_7.png" /> Suunnitteilla'
            });
var format_Rakenteilla_8 = new ol.format.GeoJSON();
var features_Rakenteilla_8 = format_Rakenteilla_8.readFeatures(json_Rakenteilla_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Rakenteilla_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Rakenteilla_8.addFeatures(features_Rakenteilla_8);
var lyr_Rakenteilla_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Rakenteilla_8, 
                style: style_Rakenteilla_8,
                popuplayertitle: 'Rakenteilla',
                interactive: true,
                title: '<img src="styles/legend/Rakenteilla_8.png" /> Rakenteilla'
            });
var format_Toiminnassa_9 = new ol.format.GeoJSON();
var features_Toiminnassa_9 = format_Toiminnassa_9.readFeatures(json_Toiminnassa_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Toiminnassa_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Toiminnassa_9.addFeatures(features_Toiminnassa_9);
var lyr_Toiminnassa_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Toiminnassa_9, 
                style: style_Toiminnassa_9,
                popuplayertitle: 'Toiminnassa',
                interactive: true,
                title: '<img src="styles/legend/Toiminnassa_9.png" /> Toiminnassa'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_Kattavaverkko_1.setVisible(true);lyr_Ydinverkko_2.setVisible(true);lyr_Liikenteensolmukunnat_3.setVisible(false);lyr_solmukunnat_pisteclipped_4.setVisible(false);lyr_TENTsatamat_5.setVisible(true);lyr_Tehtaat_6.setVisible(true);lyr_Suunnitteilla_7.setVisible(true);lyr_Rakenteilla_8.setVisible(true);lyr_Toiminnassa_9.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_Kattavaverkko_1,lyr_Ydinverkko_2,lyr_Liikenteensolmukunnat_3,lyr_solmukunnat_pisteclipped_4,lyr_TENTsatamat_5,lyr_Tehtaat_6,lyr_Suunnitteilla_7,lyr_Rakenteilla_8,lyr_Toiminnassa_9];
...
lyr_Liikenteensolmukunnat_3.set('fieldAliases', {'fid': 'fid', 'GML_ID': 'GML_ID', 'NATCODE': 'NATCODE', 'NAMEFIN': 'NAMEFIN', 'NAMESWE': 'NAMESWE', 'LANDAREA': 'LANDAREA', 'FRESHWAREA': 'FRESHWAREA', 'SEAWAREA': 'SEAWAREA', 'TOTALAREA': 'TOTALAREA', });
lyr_solmukunnat_pisteclipped_4.set('fieldAliases', {'fid': 'fid', 'GML_ID': 'GML_ID', 'NATCODE': 'NATCODE', 'NAMEFIN': 'NAMEFIN', 'NAMESWE': 'NAMESWE', 'LANDAREA': 'LANDAREA', 'FRESHWAREA': 'FRESHWAREA', 'SEAWAREA': 'SEAWAREA', 'TOTALAREA': 'TOTALAREA', 'MÄT': 'MÄT', 'KUT': 'KUT', 'LET': 'LET', 'MÄK': 'MÄK', 'KUK': 'KUK', 'LEK': 'LEK', 'Yhteensä': 'Yhteensä', 'MÄT_1': 'MÄT_1', 'KUT_1': 'KUT_1', 'LET_1': 'LET_1', 'MÄK_1': 'MÄK_1', 'KUK_1': 'KUK_1', 'LEK_1': 'LEK_1', 'Yhteensä_1': 'Yhteensä_1', 'MÄT_2': 'MÄT_2', 'KUT_2': 'KUT_2', 'LET_2': 'LET_2', 'MÄK_2': 'MÄK_2', 'KUK_2': 'KUK_2', 'LEK_2': 'LEK_2', 'Yhteensä_2': 'Yhteensä_2', });
...
lyr_Liikenteensolmukunnat_3.set('fieldImages', {'fid': 'TextEdit', 'GML_ID': 'TextEdit', 'NATCODE': 'TextEdit', 'NAMEFIN': 'TextEdit', 'NAMESWE': 'TextEdit', 'LANDAREA': 'TextEdit', 'FRESHWAREA': 'TextEdit', 'SEAWAREA': 'TextEdit', 'TOTALAREA': 'TextEdit', });
lyr_solmukunnat_pisteclipped_4.set('fieldImages', {'fid': 'TextEdit', 'GML_ID': 'TextEdit', 'NATCODE': 'TextEdit', 'NAMEFIN': 'TextEdit', 'NAMESWE': 'TextEdit', 'LANDAREA': 'TextEdit', 'FRESHWAREA': 'TextEdit', 'SEAWAREA': 'TextEdit', 'TOTALAREA': 'TextEdit', 'MÄT': 'TextEdit', 'KUT': 'TextEdit', 'LET': 'TextEdit', 'MÄK': 'TextEdit', 'KUK': 'TextEdit', 'LEK': 'TextEdit', 'Yhteensä': 'TextEdit', 'MÄT_1': 'TextEdit', 'KUT_1': 'TextEdit', 'LET_1': 'TextEdit', 'MÄK_1': 'TextEdit', 'KUK_1': 'TextEdit', 'LEK_1': 'TextEdit', 'Yhteensä_1': 'TextEdit', 'MÄT_2': 'TextEdit', 'KUT_2': 'TextEdit', 'LET_2': 'TextEdit', 'MÄK_2': 'TextEdit', 'KUK_2': 'TextEdit', 'LEK_2': 'TextEdit', 'Yhteensä_2': 'TextEdit', });
...
lyr_Liikenteensolmukunnat_3.set('fieldLabels', {'fid': 'no label', 'GML_ID': 'no label', 'NATCODE': 'no label', 'NAMEFIN': 'header label - always visible', 'NAMESWE': 'no label', 'LANDAREA': 'no label', 'FRESHWAREA': 'no label', 'SEAWAREA': 'no label', 'TOTALAREA': 'no label', });
lyr_solmukunnat_pisteclipped_4.set('fieldLabels', {'fid': 'no label', 'GML_ID': 'no label', 'NATCODE': 'no label', 'NAMEFIN': 'header label - always visible', 'NAMESWE': 'no label', 'LANDAREA': 'no label', 'FRESHWAREA': 'no label', 'SEAWAREA': 'no label', 'TOTALAREA': 'no label', 'MÄT': 'no label', 'KUT': 'no label', 'LET': 'no label', 'MÄK': 'no label', 'KUK': 'no label', 'LEK': 'no label', 'Yhteensä': 'no label', 'MÄT_1': 'no label', 'KUT_1': 'no label', 'LET_1': 'no label', 'MÄK_1': 'no label', 'KUK_1': 'no label', 'LEK_1': 'no label', 'Yhteensä_1': 'no label', 'MÄT_2': 'no label', 'KUT_2': 'no label', 'LET_2': 'no label', 'MÄK_2': 'no label', 'KUK_2': 'no label', 'LEK_2': 'no label', 'Yhteensä_2': 'no label', });
lyr_TENTsatamat_5.set('fieldLabels', {'TEN-T-satama': 'header label - always visible', 'Ydin/kattava': 'header label - always visible', 'Kunta': 'header label - always visible', 'SijaintiN': 'hidden field', 'SijaintiE': 'hidden field', 'Lähde': 'hidden field', 'Muuta': 'hidden field', });
lyr_Tehtaat_6.set('fieldLabels', {'nro2015': 'hidden field', 'NETRS': 'hidden field', 'IETRS': 'hidden field', 'Tuotantolaitos': 'header label - always visible', 'Tuotsuunta': 'header label - always visible', 'Firma': 'hidden field', 'Tehdas': 'header label - always visible', 'Tyyppi': 'header label - always visible', 'Maakunta': 'hidden field', 'ELY-keskus': 'hidden field', });
lyr_Suunnitteilla_7.set('fieldLabels', {'fid': 'hidden field', 'Yritys': 'header label - always visible', 'Nimi': 'hidden field', 'Käyttövoima': 'header label - always visible', 'Kapasiteetti': 'header label - always visible', 'Teho kW': 'header label - always visible', 'SijaintiN': 'hidden field', 'SijaintiE': 'hidden field', 'Tilanne': 'header label - always visible', 'Kunta': 'header label - always visible', 'Lisätietoja1': 'header label - visible with data', 'Lisätietoja2': 'hidden field', 'Lisätietoja3': 'hidden field', 'Linkki': 'header label - visible with data', 'Osoite': 'header label - visible with data', 'TEN-T': 'hidden field', 'Sijaitseeko latauskenttä korkeintaan kolmen kilometrin päässä vähintään kolmen kattavaan tieverkkoon kuuluvan maantien poistumisliittymästä?': 'hidden field', 'Lähde': 'hidden field', 'Muistiinpanot': 'hidden field', 'field_19': 'no label', 'field_20': 'no label', });
lyr_Rakenteilla_8.set('fieldLabels', {'fid': 'hidden field', 'Yritys': 'header label - always visible', 'Nimi': 'hidden field', 'Käyttövoima': 'header label - always visible', 'Kapasiteetti': 'header label - always visible', 'Teho kW': 'header label - always visible', 'SijaintiN': 'hidden field', 'SijaintiE': 'hidden field', 'Tilanne': 'header label - always visible', 'Kunta': 'header label - always visible', 'Lisätietoja1': 'header label - visible with data', 'Lisätietoja2': 'hidden field', 'Lisätietoja3': 'hidden field', 'Linkki': 'header label - visible with data', 'Osoite': 'header label - visible with data', 'TEN-T': 'hidden field', 'Sijaitseeko latauskenttä korkeintaan kolmen kilometrin päässä vähintään kolmen kattavaan tieverkkoon kuuluvan maantien poistumisliittymästä?': 'hidden field', 'Lähde': 'hidden field', 'Muistiinpanot': 'hidden field', 'field_19': 'no label', 'field_20': 'no label', });
...
lyr_Toiminnassa_9.on('precompose', function(evt) {
