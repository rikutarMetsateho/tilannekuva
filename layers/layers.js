...
var format_Latauspaikat_4 = new ol.format.GeoJSON();
var features_Latauspaikat_4 = format_Latauspaikat_4.readFeatures(json_Latauspaikat_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Latauspaikat_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Latauspaikat_4.addFeatures(features_Latauspaikat_4);
var lyr_Latauspaikat_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Latauspaikat_4, 
                style: style_Latauspaikat_4,
                popuplayertitle: 'Latauspaikat',
                interactive: true,
    title: 'Latauspaikat<br />\
    <img src="styles/legend/Latauspaikat_4_0.png" /> CEF-rahoituspäätös 2025<br />\
    <img src="styles/legend/Latauspaikat_4_1.png" /> EV tukipäätös 2024<br />\
    <img src="styles/legend/Latauspaikat_4_2.png" /> EV tukipäätös 2025<br />\
    <img src="styles/legend/Latauspaikat_4_3.png" /> Rakenteilla<br />\
    <img src="styles/legend/Latauspaikat_4_4.png" /> Toiminnassa<br />' });

lyr_OpenStreetMap_0.setVisible(true);lyr_Valtatiet_1.setVisible(true);lyr_TENT_2.setVisible(true);lyr_Tehtaat_3.setVisible(true);lyr_Latauspaikat_4.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_Valtatiet_1,lyr_TENT_2,lyr_Tehtaat_3,lyr_Latauspaikat_4];
...
lyr_Latauspaikat_4.set('fieldAliases', {'fid': 'fid', 'Yritys': 'Yritys', 'Nimi': 'Nimi', 'Käyttövoima': 'Käyttövoima', 'Kapasiteetti': 'Kapasiteetti', 'Teho kW': 'Teho kW', 'SijaintiN': 'SijaintiN', 'SijaintiE': 'SijaintiE', 'Tilanne': 'Tilanne', 'Lisätietoja': 'Lisätietoja', 'Linkki': 'Linkki', 'Osoite': 'Osoite', });
...
lyr_Latauspaikat_4.set('fieldImages', {'fid': 'TextEdit', 'Yritys': 'TextEdit', 'Nimi': 'TextEdit', 'Käyttövoima': 'TextEdit', 'Kapasiteetti': 'TextEdit', 'Teho kW': 'TextEdit', 'SijaintiN': 'TextEdit', 'SijaintiE': 'TextEdit', 'Tilanne': 'TextEdit', 'Lisätietoja': 'TextEdit', 'Linkki': 'TextEdit', 'Osoite': 'TextEdit', });
...
lyr_Tehtaat_3.set('fieldLabels', {'nro2015': 'hidden field', 'NETRS': 'hidden field', 'IETRS': 'hidden field', 'Tuotantolaitos': 'hidden field', 'Tuotsuunta': 'hidden field', 'Firma': 'hidden field', 'Tehdas': 'hidden field', 'Tyyppi': 'inline label - always visible', 'Maakunta': 'hidden field', 'ELY-keskus': 'hidden field', });
lyr_Latauspaikat_4.set('fieldLabels', {'fid': 'hidden field', 'Yritys': 'inline label - always visible', 'Nimi': 'inline label - always visible', 'Käyttövoima': 'inline label - always visible', 'Kapasiteetti': 'inline label - always visible', 'Teho kW': 'inline label - always visible', 'SijaintiN': 'hidden field', 'SijaintiE': 'hidden field', 'Tilanne': 'inline label - always visible', 'Lisätietoja': 'hidden field', 'Linkki': 'hidden field', 'Osoite': 'hidden field', });
lyr_Latauspaikat_4.on('precompose', function(evt) {
